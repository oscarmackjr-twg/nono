...
status: Phase 17 (Attach-Streaming, ATCH-01) COMPLETE — verifier passed 13/13 must-haves with `status: human_needed` (4 deferred-by-design HUMAN-UAT items, NOT gaps). v2.1 needs only Phase 18 (AIPC-01) before milestone ships.
