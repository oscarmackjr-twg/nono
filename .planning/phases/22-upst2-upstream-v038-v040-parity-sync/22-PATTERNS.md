...
| `crates/nono-cli/src/audit/*.rs` (NEW: audit_integrity, audit_session, audit_ledger, audit_attestation) | 22-05 | service (ledger) | event-driven | `nono::undo::merkle::MerkleTree` (merkle.rs:36–93) for hash chain; `nono::trust::signing::sign_bytes_inner` (signing.rs:252–319) for DSSE | exact |
