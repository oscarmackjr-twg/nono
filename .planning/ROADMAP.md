...
| 20. Upstream Parity Sync (UPST) | v2.1 | 4/4 | All 4 plans complete (Wave 0+1+2 complete 2026-04-19: 20-01 rustls-webpki 0.103.12 + workspace 0.37.1; 20-02 profile extends cycle guard + claude.json symlink, commits `05c24a6`/`f8ef9dd`/`046cf2a`/merge `aa018ad`; 20-03 keyring:// URI + env-var filter flags + command_blocking_deprecation backport, commits `8cb8503`/`e6fde89`/`7a4b9fd`/`3e2d46a`/merge `9e69792`; 20-04 --allow-gpu flag (D-12) + NVIDIA Linux allowlist (D-13) + GitLab ID tokens (D-11), commits `f377a3e`/`ec73a8a`/`af5c124`; awaits verifier pass) | 2026-04-19 |
