...
| 18. Extended IPC (AIPC-01) | v2.1 | 1/4 | In progress (18-01 wire-protocol skeleton + Event/Mutex brokers + dispatcher discriminator gate COMPLETE 2026-04-19, 6 commits `51b1c12`..`3ea2017`, 65/65 plan-targeted tests pass; Phase 11 + Phase 17 invariants verified byte-identical via grep counts. 18-02 Pipe + Socket / 18-03 Job Object + profile schema + audit suite / 18-04 child-side SDK surface closing D-08 + D-09 coverage gap remain. Wave 2 → Wave 4, sequential.) | - |
