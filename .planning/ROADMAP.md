...
| 18. Extended IPC (AIPC-01) | v2.1 | 0/4 | Planned (4 plans on disk: 18-01 protocol skeleton + Event/Mutex; 18-02 Pipe + Socket; 18-03 Job Object + profile schema + audit suite; 18-04 child-side SDK surface closing D-08 + D-09 coverage gap. Wave 1 → Wave 4, sequential.) | - |
