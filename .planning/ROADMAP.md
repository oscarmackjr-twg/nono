...
- [ ] **Phase 22: UPST2 — Upstream v0.38–v0.40 Parity Sync** (6/6 plans, implementation done — awaiting `/gsd-secure-phase 22` + `/gsd-code-review 22` + `/gsd-verify-phase 22`) — ingest cross-platform feature clusters (profile struct, policy tightening, package manager, OAuth2 proxy, audit integrity) with Windows parity in lockstep — 22-01 PROF (12 commits, d7fc4ed8); 22-02 POLY (7 commits, 490a8a5c); 22-03 PKG partial close (6/8 cherry-picks; 2 deferred to v2.3 backlog); 22-04 OAUTH (14 commits, 5c8df06a); **22-05 split** into 22-05a (audit core no rename — 13 commits, d15a3ab6, AUD-01/02/03 SHA-256 portion) + 22-05b (rename + Authenticode + CLEAN-04 sweep — 7 commits, b5640cd4, AUD-04 + AUD-03 Windows portion) after CONTEXT STOP trigger #3 on 4f9552ec cherry-pick. T-22-05-04 ABSOLUTE STOP guard held end-to-end. Authenticode chain-walker subject extraction deferred to v2.3 backlog (records discriminant only).
...
- [x] 24-02-PLAN.md — GSD upstream-sync template + PROJECT.md cross-link + docs/cli/development/upstream-drift.mdx runbook (DRIFT-02)
