...
| 18.1. Extended IPC Gap Closure | v2.1 | 1/4 | In progress (18.1-01 G-02 CONIN$ prompt routing COMPLETE 2026-04-21 on windows-squash — commits `1960239` RED + `70984ac` GREEN; new `build_prompt_text` dispatcher in `terminal_approval.rs` routes AIPC kinds through `format_capability_prompt` D-04 per-kind templates + preserves Phase 11 File legacy block byte-identical; 5 `#[allow(dead_code)]` attributes removed; 6 regression tests covering all 6 HandleKind shapes; clippy/fmt/build clean; D-19 cross-phase byte-identical preservation verified. Remaining: 18.1-02 G-03 JobObject CreateJobObjectW + G-04 broker-failure flip / 18.1-03 G-06 profile widening wiring / 18.1-04 G-05 WR-01 reject-stage verification. 18.1-02..04 sequential on `supervisor.rs`. Remaining gate to v2.1 milestone tag.) | — |
